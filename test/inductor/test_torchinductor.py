...
class CommonTemplate:
    ...
    def test_full_bits_lowp(self):
        ...
        def check_use_full_bits(func, shapes, dtype):
            example_inputs = tuple(
                torch.randn(shape, dtype=dtype).to(dtype) for shape in shapes
            )
            ...
            # fake_tensor_args = tuple(
            #     fake_mode.from_tensor(x) for x in example_inputs
            # )
        ...
        def func0(arg0, arg1):
            return torch.ops.aten.sum(
                torch.ops.aten.add(torch.ops.aten.atanh(arg0), arg1)
            )
        ...
        def func1(arg0):
            ...
            return torch.ops.aten.add(torch.ops.aten.atanh(arg0), v)
        ...
        for dtype in [
            ...
            for func, shapes in zip(funcs, example_shapes):
                check_use_full_bits(func, shapes, dtype)
